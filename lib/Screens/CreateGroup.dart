...
import 'package:video/Custom%20UI/AvtarCard.dart';
...
class _CreateGroupState extends State<CreateGroup> {
  List<ChatModel> contacts = [
    // ChatModel(name: "Dev Stack", status: "A full stack developer", currentMessage: 'hello', icon: 'ff', id: null, isGroup: null, time: '54', ),
